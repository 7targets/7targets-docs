...
- schedule page example date is shown as day 1, day 3 etc..
...
- UI : schedule page to support pagination for schedule
...
- fix for Clone of Schedule not working
...
- Fix for save button on schedule description change
```
## 07 Sept 2021
```
