...
**6.** Sync the schedules from 7Targets to Hubspot. If you intend to provide the Sequence while the contact/lead is assigned to the Assistant in Hubspot, then the schedules from 7Targets has to be synced in Hubspot. These sequence will be available in the field `7Targets Sequence`. You can select the sequence you want while assigning the lead to the Assistant.
