...
Yes, you can deactivate the lead. That will stop sending the emails. To restart, can again assign another (or same) sequence/sequence to the lead to restart followups.  
...
You cannot assign the SAME lead to TWO schedules at the SAME time. One lead will be on ONE sequence at a time.
