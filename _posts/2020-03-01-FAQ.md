...
## How will be the dashboard will it be specific for a user or the same for all. How do we segregate as per the industry?
...
## If we are uploading 76 leads on a day and the assistant picks the 50 leads , what will be the status of other leads? Will the assistant start sending emails the next day without initiating by us?
...
## Once the lead is engaged the assistant will send the follow-ups as per our sequence, but what happens to the cold leads, when will be the follow-ups sent?
...
## While creating the sequence if we choose a day on weekend for the follow-ups will the assistant alerts us since they are off on weekends.
...
## How much emails can a user send on a day?  Like is it ok to schedule at different timing with the same assistant?
