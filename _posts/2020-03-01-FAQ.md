...
As a salesperson, you need to respond back to the lead within 24 hours, otherwise that lead is marked as 'Lead At Risk'.

You can find a detailed explanation [here](https://7targets.ai/help/getting-responses/assistant-notification/#notification-preference).
